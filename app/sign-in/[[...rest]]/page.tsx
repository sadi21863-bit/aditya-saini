    ...
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="flex flex-col min-h-screen bg-ic-paper px-8 py-6">
        ...
        <div className="flex-1 flex flex-col justify-center w-full max-w-[420px] mx-auto">
          ...
          <h1 className="font-display text-5xl font-normal tracking-tight text-ic-ink mb-8 leading-tight">
            Welcome back.
          </h1>
          ...
          <p className="text-center text-ic-muted text-sm mt-6">
            ...
            <Link href="/sign-up" className="text-ic-accent font-medium hover:underline">
              Claim a handle →
            </Link>
          </p>
        </div>
