...
/**
 * app/bookmarks/page.tsx — v12
 *
 * The `bookmarks` table was removed from the v12 schema.
 * This page shows a graceful "not available" state until bookmarks
 * are re-introduced with the new schema.
 */
    ...
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="text-center py-20">
        ...
        <p className="text-slate-600 text-xs mb-6">
          The bookmarks feature is being redesigned for v12.
        </p>
        <Link
          href="/feed"
