  ...
  if (confirm) {
    return (
      <div className="flex flex-col gap-2">
        <p className="text-ic-muted text-xs text-center">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl
              bg-ic-danger hover:opacity-90 text-white text-xs font-medium transition
              disabled:opacity-50"
          >
        ...
        {error && <p className="text-ic-danger text-xs text-center">{error}</p>}
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-1">
      <button
        ...
        className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl
          bg-ic-paper-deep border border-ic-rule hover:border-ic-danger
          text-ic-muted hover:text-ic-danger text-sm font-medium transition"
      >
        <LogOut size={14} />
        Leave Room
      </button>
