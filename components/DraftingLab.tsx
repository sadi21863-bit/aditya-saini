    ...
    <div className="max-w-4xl mx-auto p-8 bg-white rounded-3xl border border-slate-100 shadow-sm">
      ...
      <div className="space-y-5">
        <input
          ...
          className="w-full bg-slate-50 border border-slate-200 p-4 rounded-2xl focus:ring-2 focus:ring-[#0d9488]/20 focus:border-[#0d9488] outline-none font-bold text-slate-900 placeholder:text-slate-400"
          value={form.title}
          onChange={(e) => setForm({ ...form, title: e.target.value })}
        />
        <input
          placeholder="Category (e.g. Tech, Energy, Social)"
          className="w-full bg-slate-50 border border-slate-200 p-4 rounded-2xl focus:ring-2 focus:ring-[#0d9488]/20 focus:border-[#0d9488] outline-none text-slate-900 placeholder:text-slate-400"
          value={form.category}
        ...
        <textarea
          ...
          maxLength={140}
          className="w-full bg-slate-50 border border-slate-200 p-4 rounded-2xl focus:ring-2 focus:ring-[#0d9488]/20 focus:border-[#0d9488] outline-none italic text-slate-600 placeholder:text-slate-400"
          value={form.hook}
          onChange={(e) => setForm({ ...form, hook: e.target.value })}
        />
        <textarea
          placeholder="Full content (aim for 250+ words, use ## for headings and * for bullet points to boost your score)"
          className="w-full h-56 bg-slate-50 border border-slate-200 p-4 rounded-2xl focus:ring-2 focus:ring-[#0d9488]/20 focus:border-[#0d9488] outline-none leading-relaxed text-slate-900 placeholder:text-slate-400 resize-none"
          value={form.content}
      ...
      {message.text && (
        <div className={`mt-5 p-4 rounded-2xl flex items-center gap-3 border text-sm font-medium ${
      ...
      <div className="mt-6 flex justify-between items-center pt-6 border-t border-slate-100">
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="flex items-center gap-2 px-6 py-3 rounded-2xl font-bold bg-[#0d9488] text-white hover:bg-teal-700 disabled:bg-slate-200 disabled:text-slate-400 transition-all shadow-md"
        >
